...
function App() {
  ...
  const contractAddress = "0x1C737d6f67B02Bc38A89ed20f28dBC892B956f2D"; // Paste the address recieved from Remix IDE here
    ...
    <div className="App">
      <header className="App-header">
        ...
        /* STEP 3: MAIN APP - Show if connected and registered */
         /* Show last expense label Fetches and shows the description of the most recent expense added.*/
        : (
          <div>
            <h2>Welcome, {name}</h2>
            <p>Account: {account}</p>
